...
async function trainNlp() {
    ...
    manager.addDocument('en', "How do I invest in stocks?", 'chitchat_invest_in_stocks');
    manager.addDocument('en', "How do I start investing?", 'chitchat_invest_in_stocks');
    manager.addDocument('en', "How can I start investing in stocks?", 'chitchat_invest_in_stocks');
    manager.addDocument('en', "What's the best way to organize a closet?", 'chitchat_rganize_closet');
    manager.addDocument('en', "How should I organize my closet?", 'chitchat_organize_closet');
    manager.addDocument('en', "How do I remove stains?", 'chitchat_remove_stains');
    manager.addDocument('en', "How do I remove stains from clothes?", 'chitchat_remove_stains');
    manager.addDocument('en', "What's the best way to get stains out of clothes?", 'chitchat_remove_stains');
    ...
    manager.addDocument('en', "What can I do to get a raise?", 'chitchat_get_raise');
    ...
    manager.addAnswer('en', 'chitchat_invest_in_stocks', "To start investing, you can open a brokerage account and buy shares of companies. Research and diversify for better long-term results."); 
    manager.addAnswer('en', 'chitchat_organize_closet', "Start by decluttering, then group items by category or color. Use bins and shelves for better storage.");    
    manager.addAnswer('en', 'chitchat_remove_stains', "Pre-treat the stain with detergent or a stain remover, then wash as usual. Act fast for better results.");
