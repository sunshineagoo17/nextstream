...
router.post('/reset-password', async (req, res) => {
  ...
  try {
    ...
    console.log('New hashed password:', hashedPassword); // Log the new hashed password
    ...
    console.log('Password updated in database:', hashedPassword); // Log after updating the password
