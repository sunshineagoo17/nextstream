...
- **Streamboard** - Drag, drop, done—easily manage your favourites. Search, discover, and update your must-watch list. Got empty cards? Add titles and organize in no time.
...
![Friends List](/docs/images/friends_list.png)
