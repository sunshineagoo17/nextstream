...
const SubscriptionStatus = () => {
  ...
  return (
    <div className="subscription-status">
      <div className="subscription-status__container">
        ...
        <div className="subscription-status__active">
          <div className="subscription-status__select" onClick={toggleActiveStatus}>
            <div className={`subscription-status__checkbox ${isActive ? 'subscription-status__active' : ''}`}>
      ...
      <div
        className={`subscription-status__delete-account ${deleteAccount ? 'subscription-status__delete' : ''}`}
