    ...
    <>
      ...
      <div className="auth-search-results">
        <div className="auth-search-results__content-card">
          ...
          <p className="auth-search-results__intro">Hiiii Here's where you'll find your top 3 results.</p>
          {!isAuthenticated && (
            <div>
              <p className="auth-search-results__text--top">
                To view where these titles are streaming and add them to your calendar, please{' '}
                <button className="auth-search-results__login-link" onClick={handleLoginClick} aria-label="Go to Login Page">
                  sign in.
                </button>
              </p>
              <p className="auth-search-results__text--bottom">
                Don't have an account?{' '}
                <button className="auth-search-results__register-link" onClick={handleRegisterClick} aria-label="Go to Register Page">
                  Register
                </button>{' '}
                now!
              </p>
